...
import {ChainConfig} from "tyslinjs-ws";
...
var test = function(key) {
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("Create TYS short address", function() {
            ...
            it("TYS public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    // delegate0
    // sourced from: ./tyslin/programs/utils/bts_create_key
    ...
    // https://github.com/Tyslin/tyslin/blob/2602504998dcd63788e106260895769697f62b07/libraries/wallet/wallet_db.cpp#L103-L108
