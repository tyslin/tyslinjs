...
describe("TransactionBuilder", () => {
    ...
    before(function() {
        /* use wss://eu-west-fra.district1.io:9090 if no local node is available */
        return new Promise(function(resolve, reject) {
            Apis.instance("wss://eu-west-fra.district1.io:9090", true)
    ...
    it("Transfer", () => {
        ...
        assert.doesNotThrow(function() {
            tr.add_type_operation("transfer", {
                ...
                memo: {
                    from: "TYS1111111111111111111111111111111114T1Anm",
                    to: "TYS1111111111111111111111111111111114T1Anm",
                    nonce: 0,
                    message: ""
                }
            });
