...
Pure JavaScript Tyslin library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
[![npm version](https://img.shields.io/npm/v/tyslinjs.svg?style=flat-square)](https://www.npmjs.com/package/tyslinjs)
[![npm downloads](https://img.shields.io/npm/dm/tyslinjs.svg?style=flat-square)](https://www.npmjs.com/package/tyslinjs)
...
var {ChainStore} = require("tyslinjs");
...
```
var {PrivateKey, key} = require("tyslinjs");
